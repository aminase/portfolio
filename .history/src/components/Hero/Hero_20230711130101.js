  ...
  <Section row nopadding>
    <LeftSection>
      ...
      <SectionText>
        ...
        ME(R/V)N(MongoDB, Express.js, React.js /Vue.js, Nodejs), ReactNative. The use of these
        ...
        Python. Aside from technical skills, I am a great communicator and a team player.
      </SectionText>
