export const projects = [
  {
    title: 'Movie DB',
    description:
      'Using ReactJS, Redux-Saga, TypeScript and styled components movie db is created - from start to finish. Application  is created using https://api.themoviedb.org/ - open source API. User can search for movie or TV show and get its details.',
    image: '/images/1.png',
  ...
  },
  {
    ...
    description:
      'This is a code repository for application that allows transfer of large video chunks. Application developed using ReactJS, TypeScript, TailwindCSS, Redux-Saga.',
    image: '/images/3.jpg',
