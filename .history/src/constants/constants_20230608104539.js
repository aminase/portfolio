export const projects = [
  {
    title: 'Movie DB',
    description:
      'Using ReactJS, Redux-Saga, TypeScript and styled components movie db is created - from start to finish. Movie db application created using https://api.themoviedb.org/, open source API. User can search for movie or TV show and get its details.',
    image: '/images/1.png',
